...
set_property PACKAGE_PIN V9 [get_ports {JLED[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {JLED[0]}]
#Bank = 34, Pin name = IO_L24P_T3_34,						Sch name = LED2
set_property PACKAGE_PIN R8 [get_ports {JLED[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {JLED[1]}]
#Bank = 34, Pin name = IO_L23N_T3_34,						Sch name = LED3
set_property PACKAGE_PIN T6 [get_ports {JLED[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {JLED[2]}]
...
set_property PACKAGE_PIN L3 [get_ports {JSEG[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {JSEG[0]}]
#Bank = 34, Pin name = IO_L3N_T0_DQS_34,					Sch name = CB
set_property PACKAGE_PIN N1 [get_ports {JSEG[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {JSEG[1]}]
#Bank = 34, Pin name = IO_L6N_T0_VREF_34,					Sch name = CC
set_property PACKAGE_PIN L5 [get_ports {JSEG[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {JSEG[2]}]
#Bank = 34, Pin name = IO_L5N_T0_34,						Sch name = CD
set_property PACKAGE_PIN L4 [get_ports {JSEG[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {JSEG[3]}]
#Bank = 34, Pin name = IO_L2P_T0_34,						Sch name = CE
set_property PACKAGE_PIN K3 [get_ports {JSEG[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {JSEG[4]}]
#Bank = 34, Pin name = IO_L4N_T0_34,						Sch name = CF
set_property PACKAGE_PIN M2 [get_ports {JSEG[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {JSEG[5]}]
#Bank = 34, Pin name = IO_L6P_T0_34,						Sch name = CG
set_property PACKAGE_PIN L6 [get_ports {JSEG[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {JSEG[6]}]
...
set_property PACKAGE_PIN N6 [get_ports {JAN[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {JAN[0]}]
#Bank = 34, Pin name = IO_L18P_T2_34,						Sch name = AN1
set_property PACKAGE_PIN M6 [get_ports {JAN[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {JAN[1]}]
#Bank = 34, Pin name = IO_L4P_T0_34,						Sch name = AN2
set_property PACKAGE_PIN M3 [get_ports {JAN[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {JAN[2]}]
#Bank = 34, Pin name = IO_L13_T2_MRCC_34,					Sch name = AN3
set_property PACKAGE_PIN N5 [get_ports {JAN[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {JAN[3]}]
...
set_property PACKAGE_PIN E16 [get_ports bouton_centre]						
	set_property IOSTANDARD LVCMOS33 [get_ports bouton_centre]
#Bank = 15, Pin name = IO_L14P_T2_SRCC_15,					Sch name = BTNU
set_property PACKAGE_PIN F15 [get_ports bouton_gauche]						
	set_property IOSTANDARD LVCMOS33 [get_ports bouton_gauche]
#Bank = CONFIG, Pin name = IO_L15N_T2_DQS_DOUT_CSO_B_14,	Sch name = BTNL
set_property PACKAGE_PIN T16 [get_ports bouton_bas]						
	set_property IOSTANDARD LVCMOS33 [get_ports bouton_bas]
#Bank = 14, Pin name = IO_25_14,							Sch name = BTNR
set_property PACKAGE_PIN R10 [get_ports bouton_haut]						
	set_property IOSTANDARD LVCMOS33 [get_ports bouton_haut]
#Bank = 14, Pin name = IO_L21P_T3_DQS_14,					Sch name = BTND
set_property PACKAGE_PIN V10 [get_ports bouton_droit]						
	set_property IOSTANDARD LVCMOS33 [get_ports bouton_droit]
...
#set_property PACKAGE_PIN D17 [get_ports {oui}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {oui}]
